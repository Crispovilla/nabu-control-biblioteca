...
const ListarLibros = () => {
    ...
    const results = !buscar ? libros : libros.filter((val) =>
     val.nombre.toLowerCase().includes(buscar.toLowerCase()))


/*     const disponibilidad = () => {
      const queryDoc = getFirestore();
      const disponibilidad = doc(queryDoc, 'libros', '6k0uGJvLl1ZXpSbkkdhg');
      getDoc(disponibilidad).then(res => console.log({id: res.id, ...res.data()}))
              ...
              {results.map((libro) => (
                <tr key={libro.id}>
                  ...
                  <td>
                    ...
                    {libro.disponible === false && <MdOutlineRemoveDone color="red" />}               
                  </td>         
                  ...
                  <td className="actions">
                    ...
                    >
                      <i className="action-buttons"><IoHandRightOutline /></i>
                    </Link>
                  </td>
